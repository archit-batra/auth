...
<html>
    <head>
        <title>Narnix Partner Portal</title>
        <meta charset="UTF-8">
...
<% try{
        ...
        try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/nar","root","")) {
            ...
            PreparedStatement ps=con.prepareStatement("select name, last_name from partners where email=?");
            ps.setString(1, e);
...
<ul class="sidenav">
  <li><a class="active" href="partner.jsp">Home</a></li>
